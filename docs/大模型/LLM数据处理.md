...
|类型|jsonl文件大小|2K长度划分|句子数量(累计)|tokens(累计)|
|---|---|:--|---|---|
|工艺手册|11.7M|2217|82609|4197617|
|成本清单|5.06M|19645|101057|5549871|
|施工数据|159M|51171|1197619|62166983|
|论文+规范|26.4+43.5=69.9M|66138|1618639|86766539|
|合同|39.3M|75030|1831685|99486607|
...
| model     | type   | loss_strategy | data_source                               | training_tokens | max_length | sentence  | gpu_num | max_steps | micro_batch_size | optimizer | task_type | best_step | task_acc_score       |
| --------- | ------ | ------------- | ----------------------------------------- | --------------- | ---------- | --------- | ------- | --------- | :--------------- | --------- | --------- | --------- | -------------------- |
| Ernie-3.0 | micro  | mlm+sop       | 工艺手册                                  | 4,197,619       | 256        | 82,609    | 4       | 2400      | 128              | AdamW     | 分类      | 1600      | 0.882(↑0.004)验证集1 |
| Ernie-3.0 | mini   | mlm+sop       | 工艺手册                                  | 4,197,619       | 256        | 82,609    | 4       | 2400      | 128              | AdamW     | 分类      | 2400      | 0.898(↑0.017)验证集1 |
| Ernie-3.0 | medium | mlm+sop       | 工艺手册                                  | 4,197,619       | 256        | 82,609    | 4       | 2400      | 128              | AdamW     | 分类      | 960       | 0.894(↑0.01)验证集1  |
| Ernie-3.0 | base   | mlm+sop       | 工艺手册                                  | 4,197,619       | 256        | 82,609    | 4       | 2400      | 128              | AdamW     | 分类      | 960       | 0.900(↑0.014)验证集1 |
| Ernie-3.0 | mini   | mlm           | +成本清单+施工方案     +规范数据+论文数据 | 86,766,539      | 256        | 1,618,639 | 4       | 8000      | 256              | AdamW     | 分类      | 2400      | 0.790(↓0.036)验证集2 |
| Ernie-3.0 | medium | mlm           | +成本清单+施工方案     +规范数据+论文数据 | 86,766,539      | 256        | 1,618,639 | 4       | 8000      | 256              | AdamW     | 分类      | 2400      | 0.845(↑0.019)验证集2 |
| Ernie-3.0 | base   | mlm           | +成本清单+施工方案     +规范数据+论文数据 | 86,766,539      | 256        | 1,618,639 | 4       | 8000      | 256              | AdamW     | 分类      | 800       | 0.845(↑0.019)验证集2 |
| Ernie-3.0 | medium | mlm           | +合同数据                                 | 99,486,607      | 2048       | 75,030    | 4       | 6000      | 256              | AdamW     | 分类      | 600       | 0.849(↑0.023)验证集2 |
