...
加载torch版的huggingface的ernie结构
torch_model = TorchErnieModel.from_pretrained('/workspace/custom_project/pretrain_model_file/Ernie-Torch-model/ernie-3.0-base-zh')  
    print(torch_model)
